...
public class Town {
    ...
    public boolean leaveTown() {
        ...
        if (canLeaveTown) {
            ...
            if (checkItemBreak() && !hunter.getDifficulty().equals("e")) {
    ...
    public void lookForTrouble() {
        ...
        if (Math.random() > noTroubleChance) {
            ...
            if (hunter.hasItemInKit("sword")) {
                printMessage = Colors.PURPLE + "It's a sword 🤯!!!\nplz no kill me" + Colors.RESET;
                printMessage += "\nHe runs away and you receive " + goldDiff + " gold.";
